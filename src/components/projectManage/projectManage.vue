                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button
                                ...
                                size="mini"
                                type="success"
                                @click="handleState(scope.$index, scope.row)">批准</el-button>
                        <el-button
                                v-else="scope.row.state == 1"
                                class="tabBtn"
                                size="mini"
                                type="ifon"
                                @click="handleState(scope.$index, scope.row)">取消批准</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getsubjectList(){
                ...
                service.subjectList(data).then(data => {
                    if(data.data.success){
                        this.tableData = data.data.data.items;
                        this.total = data.data.data.totalNum;
                    }
